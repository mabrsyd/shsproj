<nav class="dark:bg-gray-900 border-b border-gray-600"  x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-8 w-8" src="{{ asset('img/shs.png') }}" alt="logo_shs" alt="Your Company">
          </div>
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <x-nav-link href="/projects" :active="request()-> is ('projects')">Status</x-nav-link>
              @if(Auth::check() && Auth::user()->usertype == 'admin')
                <x-nav-link href="/admin/inventory" :active="request()->is('admin_inventory')">Inventory</x-nav-link>
              @else
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="flex flex-col items-start justify-start top-0">
        <div class="divider divider-primary"><x-user_auth></x-user_auth></div>
